 ...
 *
 * @author Lee Stemkoski, Benjamin Burtscher
 */
public class BaseActor extends Actor {
     ...
     * @param s the stage where the actor should be placed on
     */
     ...
     */
    private static void setWorldBounds(float width, float height) {
     ...
     */
    private static ArrayList<BaseActor> getList(Stage stage, String className) {
        ...
        for (Actor a : stage.getActors()) {
            if (theClass != null && theClass.isInstance(a)) list.add((BaseActor) a);
        }
     ...
     *
     * @param stage where the actor should be displayed
     * @param className name of a class that extends the BaseActor class
     ...
     * @see #applyPhysics
     */
    private void accelerateAtAngle(float angle) {
        accelerationVec.add(
